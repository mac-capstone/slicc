...
export function CycleBanner({
  ...
  const cycleIdentity = useMemo(
    () =>
      JSON.stringify({
        edges: cycle.edges,
        netting: cycle.nettingAmount,
      }),
    [cycle.edges, cycle.nettingAmount]
  );
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              console.error('Cycle netting failed:', err);
  ...
  return (
    <View className="mx-4 mt-4 rounded-xl bg-red-900/30 px-4 py-3">
      ...
      <Pressable
        ...
        accessibilityLabel="Simplify expense flow"
        accessibilityHint="Reduces circular debt by cancelling out mutual obligations"
