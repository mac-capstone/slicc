...
const mockEvents = [
  {
    ...
    startDate: admin.firestore.Timestamp.fromDate(new Date('2026-03-15 18:00')),
    endDate: admin.firestore.Timestamp.fromDate(new Date('2026-03-15 22:00')),
    expenseIds: ['exp_boston_pizza'],
    isRecurring: true,
    recurringInterval: 1,
  ...
  },
  {
    ...
    startDate: admin.firestore.Timestamp.fromDate(new Date('2026-03-20 19:00')),
    endDate: admin.firestore.Timestamp.fromDate(new Date('2026-03-20 21:30')),
    expenseIds: ['exp_hai_di_lao'],
    isRecurring: false,
    location: 'Hai Di Lao',
...
const rawExpenses: RawExpense[] = [
  {
    ...
    doc: {
      name: 'Boston Pizza',
      date: admin.firestore.Timestamp.fromDate(new Date('2026-03-15 18:00')),
      createdBy: 'user_ankush',
  ...
  },
  {
    ...
    doc: {
      name: 'Hai Di Lao',
      date: admin.firestore.Timestamp.fromDate(new Date('2026-03-20 19:00')),
      createdBy: 'user_michael',
...
const mockNotifications = [
  ...
  },
  {
    ...
    isRead: true,
    createdAt: admin.firestore.Timestamp.fromDate(new Date('2026-03-01 10:00')),
    readAt: admin.firestore.Timestamp.fromDate(new Date('2026-03-02 10:00')),
  },
  {
